...
public class ServiceExceptionAspect {
    ...
    //public final static Logger LOGGER = Logger.getLogger(ServiceExceptionAspect.class);
    public final static Logger LOGGER = LoggerFactory.getLogger(ServiceExceptionAspect.class);
